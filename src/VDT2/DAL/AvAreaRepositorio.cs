...
namespace VDT2.DAL
{
    public class AvAreaRepositorio
    {
        public static List<AvArea> Listar(int clientId, VDT2.Models.Configuracao configuracao)
            {
            ...
            try
                ...
                using (var contexto = new GeralDbContext(configuracao))
                    ...
                    AvArea = contexto.AvArea.FromSql(chamada, parametros).ToList();
                    return AvArea;
                    }
                }
