...
namespace VDT2.DAL
{
    public class AvCondicaoRepositorio
        {
        public static List<AvCondicao> Listar(int clientId, VDT2.Models.Configuracao configuracao)
            {

            List<AvCondicao> AvCondicao;
            ...
            try
                ...
                using (var contexto = new GeralDbContext(configuracao))
                    ...
                    AvCondicao = contexto.AvCondicao.FromSql(chamada, parametros).ToList();
                    return AvCondicao;
                    }
                }
