        ...
        public static List<Models.Marca> Listar(int clientId, VDT2.Models.Configuracao configuracao)
            ...
            try
                ...
                using (var contexto = new GeralDbContext(configuracao))
                    ...
                    var contador = listaMarcas.Count();
                    #region gravalogResultado
                    Diag.Log.Grava(
                        new Diag.LogItem()
                            {
                            Nivel = Diag.Nivel.Informacao,
                            Mensagem = $"MarcaRepositorio.Listar realizado com sucesso:  Registros encontrados: {contador}"
                            });
                    #endregion  
                    return listaMarcas;
                    }
                ...
                using (var contexto = new GeralDbContext(configuracao))
                    ...
                    Diag.Log.Grava(
                        new Diag.LogItem()
                            {
                            Nivel = Diag.Nivel.Informacao,
                            Mensagem = $"MarcaRepositorio.Inserir realizado com sucesso:  Dados atualizados | Marca_ID {id}"
                            });
                    #endregion  
                    return id;
                    }
